...
public class ImageUtils {
    ...
    public static void main(String[] args) {
        // 1-缩放图像：
//        // 方法一：按比例缩放
//        ImageUtils.scale("E:/tp/2.jpg", "E:/tp/22.jpg",3, false);//测试OK true[放大]|false[缩小]
//        // 方法二：按高度和宽度缩放
        ImageUtils.scale2("E:/tp/2.jpg", "E:/tp/22.jpg",30,30, true);//测试OK true[结果图片设置多大就是多大，有补白]|false[有可能只有一边有设置这么大，具体看图片与设置比例关系]

//        // 2-切割图像：
//        // 方法一：按指定起点坐标和宽高切割
//        ImageUtils.cut("E:/tp/2.jpg", "E:/tp/22.jpg", 0, 0,50,50);//测试OK
//        // 方法二：指定切片的行数和列数
//        ImageUtils.cut2("E:/tp/2.jpg", "E:/tp/22.jpg", 2, 2 );//测试OK
//        // 方法三：指定切片的宽度和高度
//        ImageUtils.cut3("E:/tp/2.jpg", "E:/tp/22.jpg", 300, 300 );//测试OK
//
//
//        // 3-图像类型转换：
